...
def save_quotes(quotes, filename="data.json"):  # Объявляем функцию для сохранения цитат в файл
    ...
    print("Цитаты сохранены в файл")  # Выводим сообщение о успешном сохранении

def generate_html_table(quotes, output_file='quotes.html'): # Объявляем функцию для создани яфайла с цитатами
    html = '''<!DOCTYPE html>
<html lang="ru">
<head>
  <meta charset="UTF-8">
